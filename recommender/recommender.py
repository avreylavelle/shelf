...
def recommendation_scores(manga_df, profile, current_genres, current_themes, read_manga, top_n=20, mode="v3", reroll=False, seed=None, diversify=True, novelty=False, personalize=True, earliest_year=None, content_types=None, blacklist_genres=None, blacklist_themes=None):
