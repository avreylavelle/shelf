...
from legacy.cli.services.library import (
    load_manga_dataset,
    load_user_index,
    get_profile,
    similar_username,
...
from legacy.cli.ui_terminal.tui_recommend import ui_recommend
from legacy.cli.ui_terminal.tui_profile import edit_profile
